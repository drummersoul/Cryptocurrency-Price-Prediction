...
from sklearn.linear_model import LinearRegression, \
    LogisticRegression  # , SGDRegressor, Lasso, LassoCV, Ridge, RidgeCV, ElasticNet, ElasticNetCV
...
class Models:
    ...
    @staticmethod
    def __shape_validation(x_train_shape: tuple, x_test_shape: tuple, y_train_shape: tuple, y_test_shape: tuple):
    ...
    @staticmethod
    def display_classificiation_metrics(trained_classifier, x_test, y_test, model_name=""):
        ...
        precision, recall, f1_score, support = precision_recall_fscore_support(y_test, y_test_predicted,
                                                                               average='binary')
    ...
    @staticmethod
    def class_prediction_error(x_train: pd.DataFrame, y_train: pd.DataFrame, x_test: pd.DataFrame,
                               y_test: pd.DataFrame, model, model_name: str):
    ...
    @staticmethod
    def display_grid_search_result(grid_search, x_train: pd.DataFrame, x_test: pd.DataFrame, y_train: pd.Series,
                                   y_test: pd.Series):
